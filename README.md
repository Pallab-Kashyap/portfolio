![Portfolio Preview](https://github.com/pallab-kashyap/portfolio/blob/main/public/assets/seo/og-image.png?raw=true)
...
1. Clone this repository:
   ```bash
   git clone git@github.com:Pallab-Kashyap/portfolio.git
   ```
