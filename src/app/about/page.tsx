...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "pallabkshyp@gmail",
    href: "mailto:pallabkshyp@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/pallab-kashyap-7766b1211/",
    content: "/pallab-kshyp",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/pallab-kashyap",
    content: "/pallab-kashyap",
...
const TOOLS = [
  ...
  },
  {
    name: "Redis",
    content: "Next.js is a React framework for production",
    icon: <DiRedis size={"50px"} color="#DC382D" />,
    color: "#DC382D",
  },
  {
    name: "Socket.io",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Pallab Kashyap</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Pallab, a Comp. Sci. Engineer with 1 year
